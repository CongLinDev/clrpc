...
// import conglin.clrpc.transfer.net.handler.BasicProviderChannelHandler;
...
public class QueueRequestSender extends BasicRequestSender {
    ...
    //     BasicRequest temp = requests.peek();
    //     BasicProviderChannelHandler channelHandler = consumerTransfer.chooseChannelHandler(temp.getServiceName(), temp.getRequestId());
